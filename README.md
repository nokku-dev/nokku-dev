...
- 📱 **[knockon](https://github.com/nokku-dev/knockon)** — if-then 習慣形成アプリ（React Native / Expo）｜ 📲 **[App Store で見る](https://apps.apple.com/jp/app/knockon/id6796213204)**
- 🔍 **Tazna** — AIエージェントの意思決定ポイントを抽出・可視化し、人間の判断を支援するデスクトップツール（Tauri / TypeScript）— 開発中

## Background

スタートアップの創業メンバーとしてモバイル・VRゲーム開発を6年（Unity / C#、テクニカルリード）。ゼロから週1本ペースの高速リリース体制と、KPI設計〜A/Bテストによるデータドリブンな改善サイクルを構築。現在はフリーランス。
