...
- 🛠 **dev-loop-kit** — 1リポで完結する AI 開発ループのテンプレート。設計判断（ADR）・文脈・検証ゲートを repo に閉じ込め、**上記の組織基盤なしで**同じ回し方を再現できる形にしたもの。auto-merge の条件で自律度を調整でき、開発中の知見が repo に書き戻る経路を含む
